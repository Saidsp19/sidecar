...
Track::LoaderRegistry::VersionedLoaderVector
Track::DefineLoaders()
{
...
Track::LoaderRegistry Track::loaderRegistry_(Track::DefineLoaders());

MetaTypeInfo Track::metaTypeInfo_(MetaTypeInfo::Value::kTrack, "Track", &Track::CDRLoader, &Track::XMLLoader);
...
Header::Ref
Track::CDRLoader(ACE_InputCDR& cdr)
{
    return Make(cdr);
}
