...
class TCPDataSubscriber : public DataSubscriber, public ZeroconfTypes::Subscriber {
...
public:
    ...
    */
    bool openAndInit(const std::string& key, const std::string& serviceName, int bufferSize = 0, int interface = 0);
