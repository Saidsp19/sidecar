...
UDPSocketReaderTask::Log()
{
	...
	Logger::Log::Find("SideCar.IO.UDPSocketReaderTask");
    return log_;
}
...
UDPSocketReaderTask::UDPSocketReaderTask(size_t messageSize)
    : IOTask(), reader_(messageSize)
{
    ;
}
...
bool
UDPSocketReaderTask::deliverDataMessage(ACE_Message_Block* data,
