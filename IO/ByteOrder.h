 ...
 */
    ...
    */
     ...
     */
    ByteOrder()
	: decodeSwap_(! HostIsNetwork()), encodeSwap_(! HostIsNetwork()) {}
    ...
    */
    ...
    /** Convert <b>in-place</b> a value that was read in from an external source.
        ...
        `    */
    template <typename T>
    void decode(T& value) const { decode(&value, sizeof(T)); }
    ...
    */
    template <typename T>
    void encode(T& value) const { encode(&value, sizeof(T)); }
    ...
    */
    void decode(void* ptr, size_t size) const { if (decodeSwap_) Reverse(ptr, size); }
    ...
    /** Convert <b>in-place</b> a consecutive sequence of bytes before it is written out to a sink.
        ...
        \param size number of bytes in the sequence
    */
    void encode(void* ptr, size_t size) const { if (encodeSwap_) Reverse(ptr, size); }
