...
class QDESIGNER_WIDGET_EXPORT SquareButton : public QPushButton
{
    ...
    Q_OBJECT;
        ...
        Q_PROPERTY(SideCar::GUI::LED::Color onColor READ getOnColor
                   WRITE setOnColor);
        Q_PROPERTY(SideCar::GUI::LED::Color offColor READ getOffColor
                   WRITE setOffColor);
        Q_PROPERTY(SideCar::GUI::LED::Color pendingColor READ getPendingColor
                   WRITE setPendingColor);
        ...
        Q_PROPERTY(QPoint statusPosition READ getStatusPosition
                   WRITE setStatusPosition);
