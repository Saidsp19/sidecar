...
App::App(int& argc, char** argv)
    : AppBase("ESScope", argc, argv), configuration_(0),
      channelSelectorWindow_(0), configurationWindow_(0),
      controlsWindow_(0), presetsWindow_(0), viewEditor_(0),
      mainWindow_(0)
{
...
App::makeToolWindows()
{
    ...
    configuration_ = new Configuration(channelSelectorWindow_,
                                       configurationWindow_, controlsWindow_);
