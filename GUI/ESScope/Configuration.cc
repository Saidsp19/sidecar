    ...
    : PresetManager("Configuration")
{
    ...
    extractionsChannel_ = new ChannelSetting(Extractions::GetMetaTypeInfo().getName(), this,
                                             win1->getFoundExtractions());
    rangeTruthsChannel_ = new ChannelSetting(TSPI::GetMetaTypeInfo().getName(), this,
	...
	new QSpinBoxSetting(this, win2->alphaScans_),
	new QSpinBoxSetting(this, win2->betaScans_),
	new QSpinBoxSetting(this, win2->rangeScans_),
	new QDoubleSpinBoxSetting(this, win2->alphaMin_),
	new QDoubleSpinBoxSetting(this, win2->alphaMax_),
	new QDoubleSpinBoxSetting(this, win2->betaMin_),
	new QDoubleSpinBoxSetting(this, win2->betaMax_),
	new QDoubleSpinBoxSetting(this, win2->rangeMin_),
	new QDoubleSpinBoxSetting(this, win2->rangeMax_),
	new QDoubleSpinBoxSetting(this, win2->sampleRangeMin_),
	new QDoubleSpinBoxSetting(this, win2->sampleRangeFactor_),
	new QDoubleSpinBoxSetting(this, win2->faceTilt_),
	new QDoubleSpinBoxSetting(this, win2->faceRotation_),
	new QSpinBoxSetting(this, win2->firstSample_),
	new QSpinBoxSetting(this, win2->lastSample_),
	allynHack_,
	...
	new QCheckBoxSetting(this, win2->videoColorMapEnabled_),
    ...
    history_ = new History(this, radarSettings_, extractionsImaging_,
                           rangeTruthsImaging_, bugPlotsImaging_,
                           allynHack_);
    connect(videoChannel_, SIGNAL(incoming(const MessageList&)), history_,
    ...
    connect(extractionsChannel_, SIGNAL(valueChanged(int)), history_,
            SLOT(clearExtractions()));

    connect(rangeTruthsChannel_, SIGNAL(incoming(const MessageList&)), history_,
            SLOT(processRangeTruths(const MessageList&)));
    connect(rangeTruthsChannel_, SIGNAL(valueChanged(int)), history_,
            SLOT(clearRangeTruths()));
	...
	new QGroupBoxSetting(this, win2->gridVisible_),
	new ColorButtonSetting(this, win2->gridColor_),
	new QDoubleSpinBoxSetting(this, win2->gridLineWidth_),
	new OpacitySetting(this, win2->gridOpacity_),
	new QSpinBoxSetting(this, win2->gridAlphaMajor_),
	new QSpinBoxSetting(this, win2->gridAlphaMinor_),
	new QSpinBoxSetting(this, win2->gridBetaMajor_),
	new QSpinBoxSetting(this, win2->gridBetaMinor_),
	new QSpinBoxSetting(this, win2->gridRangeMajor_),
	new QSpinBoxSetting(this, win2->gridRangeMinor_));
