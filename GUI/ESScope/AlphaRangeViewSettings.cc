...
AlphaRangeViewSettings::AlphaRangeViewSettings(
    QObject* parent, const RadarSettings* radarSettings)
    : Super(parent, radarSettings,
            ViewBounds(radarSettings->getAlphaMinMin(),
                       radarSettings->getAlphaMaxMax(),
                       radarSettings->getRangeMinMin(),
