...
RecordingSettings::RecordingSettings(BoolSetting* durationEnabled, TimeSetting* duration) :
...
void
RecordingSettings::connectWidgets(QCheckBox* durationEnabled, QTimeEdit* duration)
{
