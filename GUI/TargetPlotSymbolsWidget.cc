...
void
TargetPlotSymbolsWidget::connectExtractionsSymbolType(
    TargetPlotImaging* setting)
{
    gui_->extractions_->associateWith(setting);
}

void
TargetPlotSymbolsWidget::connectRangeTruthsSymbolType(
    TargetPlotImaging* setting)
{
...
void
TargetPlotSymbolsWidget::connectBugPlotsSymbolType(
    TargetPlotImaging* setting)
{
