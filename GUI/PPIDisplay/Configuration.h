...
public:
    ...
    BackgroundImageSettings* getBackgroundImageSettings() const
	{ return backgroundImageSettings_; }

    DecaySettings* getDecaySettings() const
	{ return decaySettings_; }
    ...
    RangeTruthsImaging* getRangeTruthsImaging() const
