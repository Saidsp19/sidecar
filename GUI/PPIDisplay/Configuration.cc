    ...
    PresetManager("Configuration")
{
    ...
    viewSettings_ = new ViewSettings(
        new DoubleSetting(this, "rangeMaxMax", 400.0), new QDoubleSpinBoxSetting(this, win2->rangeMax_),
        new QDoubleSpinBoxSetting(this, win2->viewX_), new QDoubleSpinBoxSetting(this, win2->viewY_),
        new QSpinBoxSetting(this, win2->viewZoomPower_), new QDoubleSpinBoxSetting(this, win2->viewZoomFactor_));
    ...
    decaySettings_ = new DecaySettings(new QGroupBoxSetting(this, win2->decayEnabled_),
                                       new QComboBoxSetting(this, win2->decayProfile_),
                                       new QSpinBoxSetting(this, win2->decayDistance_));

    historySettings_ = new HistorySettings(new QGroupBoxSetting(this, win2->historyEnabled_, true),
    ...
    videoImaging_ = new VideoImaging(
        ...
        new CLUTSetting(this, win2->videoColorMap_), new QGroupBoxSetting(this, win2->videoDesaturateEnabled_),
    ...
    backgroundImageSettings_ =
        new BackgroundImageSettings(new QGroupBoxSetting(this, win2->backgroundEnabled_),
                                    new PathSetting(this, win2->backgroundFile_, win2->backgroundLoad_,
                                                    "Select Background File", "Images (*.png *.xpm *.jpg)"),
    ...
    sineCosineLUT_ = Utils::SineCosineLUT::Make(RadarConfig::GetShaftEncodingMax() + 1);
