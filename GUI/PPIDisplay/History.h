...
public slots:
    ...
    */
    ...
    void setExtractionsLifeTime(int msecs) { Entry::extractionsLifeTime_ = msecs; }

    void setRangeTruthsLifeTime(int msecs) { Entry::rangeTruthsLifeTime_ = msecs; }

    void setRangeTruthsMaxTrailLength(int length) { Entry::rangeTruthsMaxTrailLength_ = length; }

    void setBugPlotsLifeTime(int msecs) { Entry::bugPlotsLifeTime_ = msecs; }
