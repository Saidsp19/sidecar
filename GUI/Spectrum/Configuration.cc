...
Configuration::Configuration(ConfigurationWindow* win)
    : Super("Configuration"),
      settings_(new Settings(
                    new QDoubleSpinBoxSetting(this,
                                              win->sampleFrequencyValue_),
                    new QComboBoxSetting(this, win->sampleFrequencyScale_),
                    new ChannelSetting(Video::GetMetaTypeInfo().getName(),
                                       this),
                    new ColorButtonSetting(this, win->liveColor_),
                    new QCheckBoxSetting(this, win->showGrid_),
                    new QComboBoxSetting(this, win->drawingMode_),
                    new QSpinBoxSetting(this, win->powerMax_))),
      fftSettings_(new FFTSettings(
                       new QComboBoxSetting(this, win->fftSize_),
                       new QSpinBoxSetting(this, win->gateStart_),
                       new QComboBoxSetting(this, win->windowType_),
                       new QCheckBoxSetting(this, win->zeroPad_),
                       new QSpinBoxSetting(this, win->workerThreadCount_),
                       new QSpinBoxSetting(this, win->smoothing_),
                       settings_)),
      spectrographImaging_(
	  new SpectrographImaging(
	      new QGroupBoxSetting(this, win->spectrographVisible_),
