...
HistoryBuffer::HistoryBuffer(int duration)
    : buffers_(), frame_(new HistoryFrame), duration_(duration)
{
...
HistoryBuffer::record(int bufferIndex, const PRIMessage::Ref& msg)
{
    ...
    while (bufferIndex >= buffers_.size()) {
