...
Configuration::Configuration(ConfigurationWindow* win)
    : Super("Configuration"),
      defaultViewSettings_(
	  new DefaultViewSettings(
	      new QSpinBoxSetting(this, win->sampleMin_),
	      new QSpinBoxSetting(this, win->sampleMax_),
	      new QDoubleSpinBoxSetting(this, win->voltageMin_),
	      new QDoubleSpinBoxSetting(this, win->voltageMax_),
	      new QCheckBoxSetting(this, win->showPeakBars_))),
      historySettings_(
	  new HistorySettings(
	      new QCheckBoxSetting(this, win->historyEnabled_),
	      new QSpinBoxSetting(this, win->historyDuration_))),
      peakBarSettings_(
	  new PeakBarSettings(
	      new QCheckBoxSetting(this, win->peakBarsEnabled_),
	      new QSpinBoxSetting(this, win->peakBarsWidth_),
	      new QSpinBoxSetting(this, win->peakBarsLifeTime_),
	      new QCheckBoxSetting(this, win->peakBarsFade_)))
{
    App* app = App::GetApp();
    BoolSetting* setting;
