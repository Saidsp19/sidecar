    ...
    PresetManager("Configuration")
{
    ...
    binaryChannel_ = new ChannelSetting(BinaryVideo::GetMetaTypeInfo().getName(), this, win1->getFoundBinary());
    extractionsChannel_ =
    ...
    viewSettings_ = new ViewSettings(
        new QSliderSetting(this, win2->azimuthZero_), new QSpinBoxSetting(this, win2->azimuthSpan_),
        new QDoubleSpinBoxSetting(this, win2->rangeMin_), new QDoubleSpinBoxSetting(this, win2->rangeMax_));
    ...
    videoImaging_ = new VideoImaging(
        ...
        new QComboBoxSetting(this, win2->videoDecimation_), new QGroupBoxSetting(this, win2->videoColorMapEnabled_),
        new CLUTSetting(this, win2->videoColorMap_));
    win2->videoPointSize_->setEnabled(true);

    binaryImaging_ = new SampleImaging(
        new QGroupBoxSetting(this, win2->binaryVisible_), new ColorButtonSetting(this, win2->binaryColor_),
        new QDoubleSpinBoxSetting(this, win2->binaryPointSize_), new OpacitySetting(this, win2->binaryOpacity_),
    ...
    extractionsImaging_ = new TargetPlotImaging(
        plotPositionFunctor_, new QGroupBoxSetting(this, win2->extractionsVisible_),
    ...
    connect(extractionsImaging_, SIGNAL(lifeTimeChanged(int)), history, SLOT(setExtractionsLifeTime(int)));
    history->setExtractionsLifeTime(extractionsImaging_->getLifeTime());

    rangeTruthsImaging_ = new TargetPlotImaging(
        plotPositionFunctor_, new QGroupBoxSetting(this, win2->rangeTruthsVisible_),
        ...
        new QCheckBoxSetting(this, win2->rangeTruthsShowTrails_), new QSpinBoxSetting(this, win2->rangeTruthsTagSize_),
        new QCheckBoxSetting(this, win2->rangeTruthsShowTags_));

    win2->rangeTruthsSymbolType_->associateWith(rangeTruthsImaging_);

    connect(rangeTruthsImaging_, SIGNAL(lifeTimeChanged(int)), history, SLOT(setRangeTruthsLifeTime(int)));
    history->setRangeTruthsLifeTime(rangeTruthsImaging_->getLifeTime());

    bugPlotsImaging_ = new TargetPlotImaging(
        plotPositionFunctor_, new QGroupBoxSetting(this, win2->bugPlotsVisible_),
        new ColorButtonSetting(this, win2->bugPlotsColor_), new QDoubleSpinBoxSetting(this, win2->bugPlotsExtent_),
        new OpacitySetting(this, win2->bugPlotsOpacity_), new QComboBoxSetting(this, win2->bugPlotsSymbolType_),
    ...
    connect(bugPlotsImaging_, SIGNAL(lifeTimeChanged(int)), history, SLOT(setBugPlotsLifeTime(int)));
    history->setBugPlotsLifeTime(bugPlotsImaging_->getLifeTime());

    rangeRingsImaging_ = new RangeRingsImaging(
        new QGroupBoxSetting(this, win2->rangeRingsVisible_), new ColorButtonSetting(this, win2->rangeRingsColor_),
        new QDoubleSpinBoxSetting(this, win2->rangeRingsLineWidth_), new OpacitySetting(this, win2->rangeRingsOpacity_),
    ...
    rangeMapImaging_ = new ChannelImaging(
        new QGroupBoxSetting(this, win2->rangeMapVisible_), new ColorButtonSetting(this, win2->rangeMapColor_),
        new QDoubleSpinBoxSetting(this, win2->rangeMapLineWidth_), new OpacitySetting(this, win2->rangeMapOpacity_));

    historySettings_ = new HistorySettings(
        new QSpinBoxSetting(this, win2->frameCount_), new QCheckBoxSetting(this, win2->frameHasGrid_),
        new QCheckBoxSetting(this, win2->frameHasRangeMap_), new QCheckBoxSetting(this, win2->frameHasExtractions_),
        new QCheckBoxSetting(this, win2->frameHasRangeTruths_), new QCheckBoxSetting(this, win2->frameHasBugPlots_));
    ...
    playerSettings_ = new PlayerSettings(new QComboBoxSetting(this, win2->playbackRate_),
                                         new QSpinBoxSetting(this, win2->playerScalingPower_),
                                         new QCheckBoxSetting(this, win2->loop_));

    framesListSettings_ = new FramesListSettings(new QSpinBoxSetting(this, win2->framesListScalingPower_));

    showCursorPositionSetting_ = new OnOffSettingsBlock(new BoolSetting(this, "showCursorPosition", true, false));
