...
HistorySettings::HistorySettings(IntSetting* frameCount,
    ...
    : Super(), frameCount_(frameCount), frameHasGrid_(frameHasGrid),
      frameHasRangeMap_(frameHasRangeMap),
      frameHasExtractions_(frameHasExtractions),
      frameHasRangeTruths_(frameHasRangeTruths),
      frameHasBugPlots_(frameHasBugPlots)
{
    ...
    connect(frameCount, SIGNAL(valueChanged(int)),
            SIGNAL(frameCountChanged(int)));
}
