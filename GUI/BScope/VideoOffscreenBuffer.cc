...
VideoOffscreenBuffer::VideoOffscreenBuffer(int width, int height, int textureType) :
    Super(App::GetApp()->getConfiguration()->getVideoImaging(), width, height, textureType)
{
