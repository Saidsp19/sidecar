#ifndef SIDECAR_GUI_BSCOPE_CURSORWIDGET_H // -*- C++ -*-
#define SIDECAR_GUI_BSCOPE_CURSORWIDGET_H
...
public:
    static QString GetFormattedPosition(double azimuth, double range);
...
private:
    ...
    const App* app_;
    const ViewSettings* viewSettings_;
    float azimuth_;
