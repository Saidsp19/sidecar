...
public:
    ...
    */
    SignalConnection connectToFoundSignal(SignalProc observer)
	{ return foundSignal_.connect(observer); }
	...
	To disconnect, simply invoke the disconnect() method of the returned object.
        ...
        \return object identifying the signal connection
    */
    SignalConnection connectToLostSignal(SignalProc observer)
	{ return lostSignal_.connect(observer); }
...
private:
    ...
    */
    static void BrowseCallback(DNSServiceRef ref, DNSServiceFlags flags, uint32_t interface,
                               DNSServiceErrorType err, const char* name, const char* type, const char* domain,
                               void* context);
};
