...
Here are some common questions:
  ...
  -# How do I convert XYZ coordinates to Range, Azimuth, and Elevation?
     - use geoXyz2Rae() \n\n
  -# How do I get a Range, Azimuth, and Elevation from one point to another and all I have are their geodetic
coordinates?
...
DLL_API int DLL_CALLCONV geoInitLocation(GEO_LOCATION* l, double lat, double lon, double hgt, int datum,
                                         const char* name);
...
DLL_API double DLL_CALLCONV geoLlh2DiffX(double lat1, double lon1, double hgt1, int datum1, double lat2, double lon2,
                                         double hgt2, int datum2);
DLL_API double DLL_CALLCONV geoLlh2DiffY(double lat1, double lon1, double hgt1, int datum1, double lat2, double lon2,
                                         double hgt2, int datum2);
DLL_API double DLL_CALLCONV geoLlh2DiffZ(double lat1, double lon1, double hgt1, int datum1, double lat2, double lon2,
                                         double hgt2, int datum2);
...
/* geoMag functions */
DLL_API int DLL_CALLCONV geomg1(double alt, double glat, double glon, double time, double* dec, double* dip, double* ti,
                                double* gv);

DLL_API int DLL_CALLCONV geoMag(double alt, double glat, double glon, double time, double* dec, double* dip, double* ti,
                                double* gv, double* adec, double* adip, double* ati, double* x, double* y, double* z,
                                double* h, double* ax, double* ay, double* az, double* ah);
