...
CPISimpleOp::processVideoCPI()
{
    ...
    default:
	LOGERROR << "Trying to process a Video CPI with an illegal operation!"
                 << std::endl;
...
CPISimpleOp::processCPI()
{
    ...
    switch(dataType_) {
    case CPISimpleOp::kVideo:
        return processVideoCPI();
    case CPISimpleOp::kBinaryVideo:
        return processBinaryVideoCPI();
