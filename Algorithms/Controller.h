...
public:
    ...
    */
    bool openAndInit(const std::string& algorithmName, const std::string& serviceName = "",
                     Algorithm* algorithm = 0, long threadFlags = kDefaultThreadFlags,
                     long threadPriority = ACE_DEFAULT_THREAD_PRIORITY, bool threaded = true);
