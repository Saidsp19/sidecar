...
public:
    ...
    TargetImage(RANGEBIN minRange, RANGEBIN maxRange, AzimuthDataPtr az, Logger::Log& logg) :
    ...
    TargetImage(RANGEBIN minRange, RANGEBIN maxRange, AzimuthDataPtr az, TYPE* data, Logger::Log& logg) :
    ...
    TargetImage(RANGEBIN minRange, RANGEBIN maxRange, PRI_COUNT rows, TYPE* data, Logger::Log& logg) :
...
#define KERNEL_3_3 ((int)1)
        ...
        xGradient = TargetImagePtr(new TargetImage(m_minRange, m_maxRange, m_az, x_grad, log));
        yGradient = TargetImagePtr(new TargetImage(m_minRange, m_maxRange, m_az, y_grad, log));
    ...
    BinaryTargetImagePtr IdentifyPeaksX()
    {
        ...
        // point the shared array pointers to the new data
        BinaryTargetImagePtr peaksImg(new BinaryTargetImage(m_minRange, m_maxRange, m_az, peaks, log));
    ...
    BinaryTargetImagePtr operator&&(const TargetImage& op)
    {
        ...
        // point the shared array pointers to the new data
        BinaryTargetImagePtr resultImg(new BinaryTargetImage(m_minRange, m_maxRange, m_az, result, log));
