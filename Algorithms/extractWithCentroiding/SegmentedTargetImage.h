...
SegmentedTargetImage(Logger::Log& logg)
    : m_wasUpdated(false), m_mergePending(false),
        m_minRangeValid(false), m_maxRangeValid(false),
        log(logg) {}
    ...
    static SegmentedTargetImagePtr Merge (TargetVector& mergers, RANGEBIN start,
                                          RANGEBIN stop,
