...
struct Test : public UnitTest::TestObj {
    Test() : UnitTest::TestObj("RangeDopplerMap") {}
    void test();
};
...
Test::test()
{
    ...
    //
    Utils::TemporaryFilePath testOutputPath("RangeDopplerMapTestOutput");
    {
        ...
        assertTrue(controller->getTask()->openAndInit("RangeDopplerMap"));
        ...
        // below)
        //
        RangeDopplerMap* algorithm = dynamic_cast<RangeDopplerMap*>(controller->getTask()->getAlgorithm());
    ...
    {
        // Change the following checks so that they apply to the RangeDopplerMap algorithm.
        //
