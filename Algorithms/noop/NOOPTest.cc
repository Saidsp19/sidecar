...
Test::test()
{
    ...
    //
    Utils::TemporaryFilePath testOutputPath("NOOPTestOutput");
    {
        ...
        assertTrue(controller->getTask()->openAndInit("NOOP"));
        ...
        // below)
        //
        NOOP* algorithm = dynamic_cast<NOOP*>(controller->getTask()->getAlgorithm());
    ...
    {
        // Change the following checks so that they apply to the NOOP algorithm.
        //
