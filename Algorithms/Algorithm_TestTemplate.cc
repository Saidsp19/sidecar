...
Test::test()
{
    ...
    //
    Utils::TemporaryFilePath testOutputPath("@@NAME@@TestOutput");
    {
        ...
        assertTrue(writer->getTask()->open("Video", testOutputPath));
        ...
        assertTrue(controller->getTask()->open("@@NAME@@"));
        ...
        // below)
        //
        @ @NAME @ @* algorithm = dynamic_cast<@ @NAME @ @*>(controller->getTask()->getAlgorithm());
    ...
    {
        // Change the following checks so that they apply to the @@NAME@@ algorithm.
        //
