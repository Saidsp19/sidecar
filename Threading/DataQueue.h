...
protected:
    ...
    Mutex::Reference mutex() const { return mutex_; }
    Condition::Reference readCondition() const { return rCond_; }
    Condition::Reference writeCondition() const { return wCond_; }
...
private:
    Mutex::Reference mutex_;
    Condition::Reference rCond_;
    Condition::Reference wCond_;
};
